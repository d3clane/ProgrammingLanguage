...
/// @brief Errors that can occure while nameTable is working. 
enum class NameTableErrors
{
    NAME_TABLE_NO_ERR,

    NAME_TABLE_MEMORY_ALLOCATION_ERROR,
    NAME_TABLE_EMPTY_ERR, 
    NAME_TABLE_IS_NULLPTR,
    NAME_TABLE_CAPACITY_OUT_OF_RANGE,
    NAME_TABLE_SIZE_OUT_OF_RANGE,
    NAME_TABLE_INVALID_CANARY, 
    NAME_TABLE_INVALID_DATA_HASH,
    NAME_TABLE_INVALID_STRUCT_HASH,
};
