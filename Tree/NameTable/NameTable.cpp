...
//---------------
    ...
    {                                           \
        NameTableErrors nameTableErr = NameTableVerify(nameTable); \
                                                \
        if (nameTableErr != NameTableErrors::NAME_TABLE_NO_ERR)                      \
        {                                       \
...
do                                      \
{                                       \
    if (ERR != NameTableErrors::NAME_TABLE_NO_ERR)                            \
        return ERR;                     \
} while (0)
                          ...
                          const HashFuncType HashFunc)
{
    ...
    NameTableErrors errors = NameTableErrors::NAME_TABLE_NO_ERR;
    nameTable->size = 0;
    ...
    {
        NameTablePrintError(NameTableErrors::NAME_TABLE_MEMORY_ALLOCATION_ERROR);  
        return NameTableErrors::NAME_TABLE_MEMORY_ALLOCATION_ERROR;   
    }
...
NameTableErrors NameTablePush(NameTableType* nameTable, const Name val)
{
    ...
    NameTableErrors nameTableReallocErr = NameTableErrors::NAME_TABLE_NO_ERR;
...
NameTableErrors NameTableVerify(NameTableType* nameTable)
{
    ...
    {  
        NameTablePrintError(NameTableErrors::NAME_TABLE_CAPACITY_OUT_OF_RANGE);
        return NameTableErrors::NAME_TABLE_CAPACITY_OUT_OF_RANGE;
    }

    if (nameTable->size > nameTable->capacity)
    {
        NameTablePrintError(NameTableErrors::NAME_TABLE_SIZE_OUT_OF_RANGE);
        return NameTableErrors::NAME_TABLE_SIZE_OUT_OF_RANGE;
    }
    ...
    (
        ...
        {
            NameTablePrintError(NameTableErrors::NAME_TABLE_INVALID_CANARY);
            return NameTableErrors::NAME_TABLE_INVALID_CANARY;
        }
    ...
    (
        ...
        {
            NameTablePrintError(NameTableErrors::NAME_TABLE_INVALID_DATA_HASH);
            return NameTableErrors::NAME_TABLE_INVALID_DATA_HASH;
        }
    )
    ...
    (
        ...
        {
            NameTablePrintError(NameTableErrors::NAME_TABLE_INVALID_STRUCT_HASH);
            nameTable->structHash = prevStructHash;
            return NameTableErrors::NAME_TABLE_INVALID_STRUCT_HASH;
        }
    )
...
void NameTablePrintError(NameTableErrors error)
{
    ...
    switch(error)
    {
        case NameTableErrors::NAME_TABLE_CAPACITY_OUT_OF_RANGE:
        ...
        case NameTableErrors::NAME_TABLE_EMPTY_ERR:
            ...
            break;
        case NameTableErrors::NAME_TABLE_SIZE_OUT_OF_RANGE:
            LOG_ERR("NameTable size is out of range.\n");
            break;
        case NameTableErrors::NAME_TABLE_MEMORY_ALLOCATION_ERROR:
            LOG_ERR("Couldn't allocate more memory for nameTable.\n");
            break;
        case NameTableErrors::NAME_TABLE_INVALID_CANARY:
            LOG_ERR("NameTable canary is invalid.\n");
            break;
        case NameTableErrors::NAME_TABLE_INVALID_DATA_HASH:
            LOG_ERR("NameTable data hash is invalid.\n");
            break;
        case NameTableErrors::NAME_TABLE_INVALID_STRUCT_HASH:
            LOG_ERR("NameTable struct hash is invalid.\n");

        case NameTableErrors::NAME_TABLE_NO_ERR:
        default:
            break;
    }
